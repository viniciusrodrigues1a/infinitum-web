...
import { DeleteIssueServiceRequest, IDeleteIssueService } from "./interfaces";
import { APIResponse } from "./type-defs/APIResponse";

export default class DeleteIssueService implements IDeleteIssueService {
  ...
  async deleteIssue({
    issueId,
  }: DeleteIssueServiceRequest): Promise<APIResponse<null>> {
    try {
      await this.axiosInstance.delete(`/issues/${issueId}`);
